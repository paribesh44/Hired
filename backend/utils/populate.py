...
def populate_seeker():
    for seeker_populate in seekers:
        ...
        profilePhoto=seeker_populate["profilePhoto"],  drivingLicenseNum=seeker_populate["drivingLicenseNum"], last_job_applied=seeker_populate["last_job_applied"], user_id=seeker_populate["user_id"])
...
def populate_job_post():
    for job_post_populate in job_posts:
        ...
        description=job_post_populate["description"], job_location=job_post_populate["job_location"], job_level=job_post_populate["job_level"], job_type=job_post_populate["job_type"],
...
def populate_target_field():
    for target_field_populate in target_fields:
        ...
        new_targetField = target_field.TargetField(name=target_field_populate["name"], languages=target_field_populate["languages"])
