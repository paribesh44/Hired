...
function ContainerBox(props) {
  const [visibilityState, setVisibilityState] = useState(
    props.user_assesment.visibility
  );
  ...
  return (
    <div className="containerboxmain">
      <Grid container direction="row" justifyContent="space-between">
        <Grid item>
          <div className="containerhead">Name of the Assesment</div>
          ...
          <Grid item>
            <Grid container direction="row">
              ...
              <Grid item>{props.user_assesment.accessed_date}</Grid>
            </Grid>
            ...
            <Grid container direction="row">
              ...
              <Grid item>{props.user_assesment.score} / 5</Grid>
            </Grid>
            ...
            <Grid container direction="row">
              ...
              <Grid item>
                <select
                  ...
                  className="status-buttonassesment"
        ...
        <Grid item>
          <Link
            to="/Assesment/ViewAssesment"
            state={{
              target_field_id: props.user_assesment.target_field_id,
              user_assesment_id: props.user_assesment.id,
              score: props.user_assesment.score,
              visibility: props.user_assesment.visibility,
              difficulty: props.user_assesment.target_field.difficulty,
            }}
