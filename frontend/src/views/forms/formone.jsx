...
const options = ["Ready to interview", "Open to offer", "Closed to interview"];
    ...
    >
      <Form className="form_main_color">
        ...
        <div>
          ...
          <Grid container justifyContent="center">
            <Grid item className="profile_subheading">
                ...
                <Grid container justifyContent="center">
                  <div>
                    ...
                    <Field
                      ...
                      id="skills"
                      name="skills"
                      placeholder="Machine Learning, Graphics Designing"
                      className="field_color"
                    />
