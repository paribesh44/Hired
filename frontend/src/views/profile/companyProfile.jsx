...
function CompanyProfile() {
  ...
  let targetMarketOptions = [
    "AI", "ML", "DL", "Web development", "Mobile development", "Data Science"
  ]
        ...
        <Grid item>
          ...
          <div className="profileContainer1">
            ...
            <div className="name">
              ...
              <p style={{color:"blueviolet", cursor:"pointer"}} onClick={handleChangeLogo}>CHANGE LOGO</p>
            </div>
          </div>
          :
          <div>
          ...
          <div className="form">
                ...
                <div className="select_roles">
                  <Select
                    ...
                    >
                        ...
                        {targetMarketOptions.map((i)=>( <MenuItem value={i}>{i}</MenuItem>))}
                    </Select>
                </div>
              </div>
            </div>
              ...
              <h4>Vision</h4>
                {!visionEdit ?
                  <div className="vision">
                    ...
                    <button onClick={()=>{setVisionEdit(!visionEdit)}}>Edit</button>
                  </div>
                  :
                <Input
                      value={vision}
            ...
            <div>
              ...
              {!descriptionEdit ?
                  <div className="vision">
                    ...
                    <button onClick={()=>{setDescriptionEdit(!descriptionEdit)}}>Edit</button>
                  </div>
                  :
                <Input
                      value={description}
            ...
            <Button name="Save Changes" addStyles={"save_changes"} onClick={handleSaveChange}></Button>
          </div>
        </Grid>
      </Grid>
    </>
