...
function EmployeePreference(props) {
    ...
    const [interested_jobs, setInterestedJobs] = useState(props.userPreference.interested_jobs)
    const [job_type, setJobType] = useState(props.userPreference.job_type)
    const [preferred_job_skills, setPreferredJobSkills] = useState(props.userPreference.preferred_job_skills)
    const [preferred_location, setPreferredLocation] = useState(props.userPreference.preferred_location)
    const [remote_onsite, setRemoteOnsite] = useState(props.userPreference.remote_onsite)
    const [minimumSalary, setMinimumSalary] = React.useState(props.userPreference.expected_min_salary/1000)
    const [maximumSalary, setMaximumSalary] = React.useState(props.userPreference.expected_max_salary/1000)
    ...
    var interested_jobs_options =[
        "frontend", "backend", "fullstack", "mobile development", "ml", "data science", "robotics"
    ]

    var preferred_location_options =[
        "Pokhara", "Banepa", "Kathmandu", "Birtnagar", "Mustang"
    ]
    ...
    <div className="field_container">
        ...
        <div className="role_container1">
            ...
            <Select
                ...
                >
                    ...
                    {interested_jobs_options.map((i)=>( <MenuItem value={i}>{i}</MenuItem>))}
                </Select>
            </div>
        </div>
        ...
        <div className="role_container1">
            ...
            <Select
                ...
                >
                    ...
                    {preferred_location_options.map((i)=>( <MenuItem value={i}>{i}</MenuItem>))}
                </Select>
            </div>
        </div>
         ...
         <div className="role_container1">
            <div className="roles">
            <p>Preferred Job Skills</p>
            </div>
            <Grid container direction="row" className="roles_container">
            {preferred_job_skills.map(
                (val) => (
                <div className="role">
                    <div>{val}</div>
                </div>
            ...
            <Select
                ...
                >
                    ...
                    {preferred_skills_options.map((i)=>( <MenuItem value={i}>{i}</MenuItem>))}
                </Select>
            </div>
        </div>
        ...
        <Grid
            ...
            <div>
                ...
                <Grid
                    ...
                    container
                    justifyContent="center">
                        <InputSlider onChange={getMinimumSalary} sliderValue={props.userPreference.expected_min_salary/1000} type="minimum" /></Grid>
                ...
                container
                justifyContent="center">
                <InputSlider onChange={getMaximumSalary} sliderValue={props.userPreference.expected_max_salary/1000} type="maximum" /></Grid>
        ...
        <Grid
            ...
            <div>
                ...
                >
                    {job_type_options.map((i)=>( <FormControlLabel value={i} control={<Radio />} label={i} />))}
                </RadioGroup>
                </Grid>
            </div>
        </Grid>
        ...
        <Grid
            ...
            <div>
                ...
                >
                    {radio_options.map((i)=>( <FormControlLabel value={i} control={<Radio />} label={i} />))}
        ...
        <Button name="Save Changes Preferences" addStyles={"save_changes"} onClick={handleSaveChangePreference} style={{marginTop: "1em", marginBottom: "5px"}}></Button>
