...
function EditJobPost() {
  ...
  const [deadlineDatePicker, setDeadlineDatePicker] = React.useState(job.deadline);
  const [jobStartDatePicker, setJobStartDatePicker] = React.useState(job.job_start_date);

  const [jobTypeDropDown, setJobTypeDropDown] = React.useState(capitalize(job.job_type));
  const [jobLevelDropDown, setJobLevelDropDown] = React.useState(capitalize(job.job_level));
  const [educationRequiredDropDown, setEducationRequiredDropDown] = React.useState(capitalize(job.education_required));

  const [remoteOnsiteRadio, setRemoteOnsiteRadio] = React.useState(capitalize(job.remote_onsite));

  const [minimumSalary, setMinimumSalary] = React.useState((job.min_salary/1000))
  const [maximumSalary, setMaximumSalary] = React.useState((job.max_salary/1000))
        ...
        <Grid
                    ...
                    <div>
                        ...
                        <Grid
                            ...
                            container
                            justifyContent="center">
                               <InputSlider onChange={getMinimumSalary} sliderValue={job.min_salary} type="minimum" /></Grid>
                        ...
                        <Grid
                            ...
                            container
                            justifyContent="center">
                               <InputSlider onChange={getMaximumSalary} sliderValue={job.max_salary} type="maximum" /></Grid>
